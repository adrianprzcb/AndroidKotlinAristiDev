...
import com.adrian.horoscapp.domain.model.HoroscopeModel
import com.adrian.horoscapp.domain.usecase.GetPredictionUseCase
    ...
    fun getHoroscope(sign: HoroscopeModel){
        ...
        viewModelScope.launch{
            ...
            if(result!=null){
                ...
                _state.value = HoroscopeDetailState.Error("Ha ocurrido un error, intentelo de nuevo")
            }
            //Hilo principal
        }
    }
